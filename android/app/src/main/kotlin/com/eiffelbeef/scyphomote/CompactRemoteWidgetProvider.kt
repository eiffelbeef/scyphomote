...
class CompactRemoteWidgetProvider : HomeWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        appWidgetIds.forEach { widgetId ->
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_remote_compact).apply {
                ...
                setOnClickPendingIntent(R.id.btn_rewind, getCommandIntent("rewind"))
                setOnClickPendingIntent(R.id.btn_play_pause, getCommandIntent("play_pause"))
                setOnClickPendingIntent(R.id.btn_fast_forward, getCommandIntent("fast_forward"))
